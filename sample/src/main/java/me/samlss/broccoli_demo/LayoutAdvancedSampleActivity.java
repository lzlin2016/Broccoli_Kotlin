...
public class LayoutAdvancedSampleActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        ivHeadPhoto = findViewById(R.id.iv_head_photo);
    ...
    private void initPlaceholders() {
        ...
        mBroccoli.addPlaceholders(PlaceholderHelper.Companion.getParameter(tvViewTimes),
                PlaceholderHelper.Companion.getParameter(tvCollectTimes),
                PlaceholderHelper.Companion.getParameter(tvPrice),
                PlaceholderHelper.Companion.getParameter(ivClock),
                PlaceholderHelper.Companion.getParameter(tvTime),
                PlaceholderHelper.Companion.getParameter(ivCalendar),
                PlaceholderHelper.Companion.getParameter(ivLocation),
                PlaceholderHelper.Companion.getParameter(tvLocation),
                PlaceholderHelper.Companion.getParameter(ivRightArrow),
                PlaceholderHelper.Companion.getParameter(ivLogo),
                PlaceholderHelper.Companion.getParameter(tvOrganizer),
                PlaceholderHelper.Companion.getParameter(tvOrganizerDescription),
                PlaceholderHelper.Companion.getParameter(tvFans),
                PlaceholderHelper.Companion.getParameter(tvFansNumber),
                PlaceholderHelper.Companion.getParameter(tvEvents),
                PlaceholderHelper.Companion.getParameter(tvEventsNumber),
                PlaceholderHelper.Companion.getParameter(tvFollow),
                PlaceholderHelper.Companion.getParameter(tvStation)
        );
